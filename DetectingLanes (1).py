...
def draw_lane_lines(image, lines, color=[255, 0, 0], thickness=20):
    ...
    for line in lines:
        if line is not None:
            lines = list(line)
            cv2.line(line_image, lines[1],lines[0],  color, thickness)
    # image1 * α + image2 * β + λ
...
cap = cv2.VideoCapture('C:/anish/1science/2018-2019/car-finding-lane-lines-master/test_videos/solidWhiteRight.mp4')
