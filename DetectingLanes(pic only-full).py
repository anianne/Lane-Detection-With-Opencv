...
test_images = plt.imread('C:/anish/1science/2018-2019/car-finding-lane-lines-master/test_images/YellowWhite.jpg')
...
def draw_lane_lines(image, lines, color=[255, 0, 0], thickness=20):
    ...
    for line in lines:
        if line is not None:
            ...
            cv2.line(line_image, liness[0],liness[1],  color, thickness)
    # image1 * α + image2 * β + λ
